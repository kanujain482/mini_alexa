    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            if 'hello'in command:
                ...
                print("I can play songs on youtube \n tell you a joke \n search on wikipedia \n tell date and time \n find your location \n locate area on map \n open different websites like instagram, facebook,youtube,gmail, git hub, stack overflow and searches on google.\n how may i help you?")
                engine_talk('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find your location, locate area on map,
                       open different websites like instagram,facebook, youtube,gmail, git hub, stack overflow and searches on google.How may i help you ?''')
